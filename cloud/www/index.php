...
<nav class="navbar navbar-default">
   <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Maps<b>Maaps</b></a>
    </div>
...
$save=mysqli_query($conn,"INSERT Into tbl_lokasi SET namalokasi='$nama', alamat='$alamat', lat='$lat', lng='$lng' ");
if($save){
